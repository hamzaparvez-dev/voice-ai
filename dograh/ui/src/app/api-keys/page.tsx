...
import { BRAND, localizePlatformLabel } from '@/constants/branding';
                                        ...
                                        >
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <span className="font-medium">{localizePlatformLabel(key.name)}</span>
                                                    {key.archived_at ? (
                        ...
                        <CardHeader>
                            <div className="flex justify-between items-center">
                                <div>
                                    ...
                                    <CardDescription>
                                        Manage service keys for accessing built-in AI services (LLM, TTS, STT)
                                    </CardDescription>
                                </div>
                                <div className="flex gap-2">
                                    ...
                                    {canCreateServiceKey ? (
                                        ...
                                        <span className="text-sm text-muted-foreground">
                                            Only one built-in service key is available in self-hosted mode.
                                        </span>
                                    )}
                                </div>
                            </div>
            ...
            <Dialog open={isCreateServiceDialogOpen} onOpenChange={setIsCreateServiceDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Create a service key to access {BRAND.name} built-in AI services (LLM, TTS, STT)
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                        <div className="grid gap-2">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                                <p className="text-sm text-blue-600 dark:text-blue-500">
                                    This key provides access to {BRAND.name} built-in AI services including LLM, Text-to-Speech, and Speech-to-Text.
